...
<form id="form-builder" method="post">
    ...
    if ($query != 'new') {
        $ID = get_id($name, $date);
        echo '<input class="ipt-hidden" id="newsletter-id"   type="text" name="id"   value="<?php echo $ID?>" title="id" hidden readonly>';
    }
    ?>
    ...
    <input     class="ipt-hidden" data-default-value="<?php if ($query != 'new'){echo ''.$name.'" value="'.$name;} ?>" id="newsletter-name" type="text"   name="name" title="name" hidden>
