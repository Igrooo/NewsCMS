<ul class="nav builder">
    ...
    if($template_mode){
        if ($query == 'new'){
          ...
          --><li class="item"><button form="form-builder" type="submit" id="builder-submit" class="btn" title="Enregistrer ce nouveau modèle" formaction="?new-template" disabled><i class="icon fas fa-check"></i><span class="item-text">Valider<span class="item-text"></button></li>';
        }
        else{
            echo'<li class="item"><button form="form-builder" type="reset"  id="builder-reset"  class="btn" title="Retirer tout les composants de ce modèle" disabled><i class="icon fas fa-undo-alt"></i><span class="item-text">Effacer tout<span class="item-text"></button></li><!--
          --><li class="item"><button form="form-builder" type="submit" id="builder-submit" class="btn" title="Enregistrer les modifications" formaction="?update-template" disabled><i class="icon fas fa-check"></i><span class="item-text">Enregistrer<span class="item-text"></button></li>';
        }
    }
    else{
        if ($query == 'new'){
